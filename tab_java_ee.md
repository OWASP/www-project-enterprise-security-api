...
* Current release: 2.3.0.0 - April 17, 2022 [(download)](https://mvnrepository.com/artifact/org.owasp.esapi/esapi/2.3.0.0)
* Release notes: [2.3.0.0 release notes](https://github.com/ESAPI/esapi-java-legacy/blob/develop/documentation/esapi4java-core-2.3.0.0-release-notes.txt)
...
* The ESAPI 2.x branch supports Java 5 and above, but the releases 2.2.0.0 and later require **Java 7** or later. Note that release 2.3.0.0 will be the **last** release to support Java 7. Thereafter, Java 8 will be the minimal supported JDK.
